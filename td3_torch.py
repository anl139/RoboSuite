...
class Agent:
    def __init__(self,actor_learning_rate,critic_learning_rate,input_dims,tau,env,gamma = 0.99,update_actor_interval = 2,warm_up = 10000,
        ...
        self.n_actions = env.action_dim
         # input dims: allow both int or (dim,)
        ...
        self.critic_1 = CriticNetwork(input_dims=(self.input_dims,), fc1_dims=layer1_size, fc2_dims=layer2_size,n_actions=self.n_actions,
                                  name='critic_1', learning_rate=critic_learning_rate)
        self.critic_2 = CriticNetwork(input_dims=(self.input_dims,), fc1_dims=layer1_size, fc2_dims=layer2_size,n_actions=self.n_actions,
                                  name='critic_2', learning_rate=critic_learning_rate)
        
        self.target_actor = ActorNetwork(input_dims=(self.input_dims,), fc1_dims=layer1_size, fc2_dims=layer2_size,n_actions=self.n_actions,
                                  name='target_actor', learning_rate=actor_learning_rate)
        self.target_critic_1 = CriticNetwork(input_dims=(self.input_dims,), fc1_dims=layer1_size, fc2_dims=layer2_size,n_actions=self.n_actions,
